...
const Knight = ({ color, size }: ThemedPieceProps) => (
  <Svg width={size} height={size}>
    { color === 'white' ?
      ...
      <G fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0z" fill="#ececec" stroke="#ececec"/>
        <Path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill="#ececec" stroke="#ececec" strokeWidth="1.49997"/>
